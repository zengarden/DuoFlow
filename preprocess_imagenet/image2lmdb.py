# copy from https://github.com/zhuyu-cs/MeanFlow
...
if __name__ == "__main__":
    imagenet_root = "./data/imagenet/train"  # Change to your ImageNet path
    lmdb_path = "./data/imagenet_train.lmdb"  # Change to your output path
